...
@router.post("/add")
def ajouter_auteur(last_name: str, first_name: str,nationalite: str, date_naissance: str, biographie: str | None = None,  date_deces: str | None = None, db: Session = Depends(get_session)):
    new_auteur = Auteur(
        last_name=last_name,
